...
public class ProgressBarScript : MonoBehaviour {
    ...
    void PrepareStars()
    {
        ...
        int starScore0 = CoreManager.Instance.levelData.starScores[0];
        int starScore1 = CoreManager.Instance.levelData.starScores[1];
        int starScore2 = CoreManager.Instance.levelData.starScores[2];
